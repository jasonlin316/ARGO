...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path',
                        type=str,
                        default='/home/jason/DDP_GNN/dataset') #/home/jason/DDP_GNN/dataset
    ...
    if arguments.cpu_process*(arguments.n_sampler+arguments.n_trainer) > psutil.cpu_count(logical=False):
        exit()
    ...
    with open('grid_serach_{}.csv'.format(arguments.dataset), 'a', newline='') as file:
